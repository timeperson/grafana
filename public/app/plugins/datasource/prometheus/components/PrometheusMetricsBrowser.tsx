...
export class UnthemedPrometheusMetricsBrowser extends React.Component<BrowserProps, BrowserState> {
  ...
  async validateSelector(selector: string) {
    ...
    this.setState({ validationStatus: `选择器有效 (找到${streams.length}个系列)` });
  }
        ...
        <HorizontalGroup align="flex-start" spacing="lg">
          <div>
            <div className={styles.section}>
              <Label description="一旦选择了一个指标，就只显示可选的标签。">1. 选择一个指标</Label>
              <div>
                <Input
          ...
          <div>
            <div className={styles.section}>
              <Label description="一旦选择了标签值，就只显示可选的标签组合。">2. 选择要搜索的标签</Label>
              <div>
                <Input
            ...
            <div className={styles.section}>
              <Label description="使用搜索字段查找所选标签的值。">3. 为标签选择(多个)值</Label>
              <div>
                <Input
