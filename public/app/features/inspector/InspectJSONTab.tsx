...
const options: Array<SelectableValue<ShowContent>> = [
  {
    label: '面板 JSON', //Panel JSON
    description: '保存在仪表板JSON中的模型，用于配置一切工作方式。', //The model saved in the dashboard JSON that configures how everything works.
    value: ShowContent.PanelJSON,
  },
  {
    label: '面板数据', //Panel data
    description: '传递给面板可视化的原始模型', //The raw model passed to the panel visualization
    value: ShowContent.PanelData,
  },
  {
    label: '数据帧 JSON', //DataFrame JSON
    description: 'JSON 格式的数据帧', //JSON formatted DataFrames
    ...
    return (
      <div className={styles.wrap}>
        <div className={styles.toolbar} aria-label={selectors.components.PanelInspector.Json.content}>
          <Field label="选择源" className="flex-grow-1">
            <Select
