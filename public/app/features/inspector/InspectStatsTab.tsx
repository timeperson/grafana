...
export const InspectStatsTab: React.FC<InspectStatsTabProps> = ({ data, timeZone }) => {
  ...
  stats.push({ displayName: '数量的查询', value: data.request.targets.length });
  stats.push({ displayName: '行总数', value: dataRows });
  ...
  return (
    <div aria-label={selectors.components.PanelInspector.Stats.content}>
      <InspectStatsTable timeZone={timeZone} name={'统计数据'} stats={stats} />
      <InspectStatsTable timeZone={timeZone} name={'数据源统计信息'} stats={dataStats} />
    </div>
  );
};
