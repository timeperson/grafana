    ...
    return (
      <>
        {logsSeries && logsSeries.length ? (
          <>
            <div className={styles.infoText}>此数据源不支持全范围直方图。图是基于中看到的日志 响应。</div>
            <ExploreGraph
              graphStyle="lines"
              data={logsSeries}
              height={150}
        ...
        <div className={styles.logOptions} ref={this.topLogsRef}>
          <InlineFieldRow>
            <InlineField label="时间" className={styles.horizontalInlineLabel} transparent>
              <InlineSwitch
                value={showTime}
            ...
            <InlineField label="唯一标签" className={styles.horizontalInlineLabel} transparent>
              <InlineSwitch
                value={showLabels}
            ...
            <InlineField label="换行符" className={styles.horizontalInlineLabel} transparent>
              <InlineSwitch
            ...
            <InlineField label="重复数据删除" className={styles.horizontalInlineLabel} transparent>
              <RadioButtonGroup
                ...
                options={[
                  {
                    ...
                    description: '显示最新到最旧的结果', // Show results newest to oldest
                  },
                  {
                    label: '最旧的第一个',
                    value: LogsSortOrder.Ascending,
                    description: '显示最旧到最新的结果', // Show results oldest to newest
                  },
                ]}
                value={logsSortOrder}
