    ...
    <>
      <div className={`cellActions ${isRightAligned ? 'cellActionsLeft' : ''}`}>
        <HorizontalGroup spacing="xs">
          ...
          {showFilters && (
            <IconButton name={'search-plus'} onClick={onFilterFor} tooltip="筛选值" {...commonButtonProps} />
          )}
          {showFilters && (
            <IconButton name={'search-minus'} onClick={onFilterOut} tooltip="排除值" {...commonButtonProps} />
          )}
        </HorizontalGroup>
      </div>
